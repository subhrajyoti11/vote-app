    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#edeaff] via-[#f5f6fa] to-[#c7d2fe]">
      <div className="bg-white/90 p-10 rounded-3xl shadow-2xl border border-[#edeaff] w-full max-w-md flex flex-col items-center">
        <div className="mb-6 flex flex-col items-center">
          ...
          <h1 className="text-3xl font-extrabold text-[#23235B] tracking-tight">Login</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 w-full">
          ...
          <button type="submit" className="w-full py-2 rounded-full bg-gradient-to-r from-[#6C63FF] to-[#3B3397] text-white font-bold shadow-lg hover:from-[#3B3397] hover:to-[#6C63FF] transition text-lg">Login</button>
        </form>
        <div className="mt-6 text-center text-sm text-gray-600">
          Don't have an account? <Link href="/register" className="text-[#3B3397] font-semibold hover:underline">Register</Link>
        </div>
      </div>
    </div>
  );
